...
DIFFICULTY_PRIOR_DEADBAND=0.03
DIFFICULTY_PRIOR_GATE_FLOOR=0.0
...
case "$VARIANT" in
  ...
  advz_strong|qstdz_strong)
    ...
    if [[ "$TASK" == "can" ]]; then
      ...
      DIFFICULTY_SIGNAL_SCALE=1.00
      DIFFICULTY_SUCCESS_THRESH_1=0.45
      DIFFICULTY_SUCCESS_THRESH_2=0.65
      DIFFICULTY_SUCCESS_OPEN_RATE=0.15
    fi
    ;;
  *)
