...
def main(cfg: OmegaConf):
	...
	if cfg.algorithm == 'dsrl_sac':
		...
		model = DSRL(
			...
			cost_open_rate=cfg.train.get("cost_open_rate", 0.05),
			...
			difficulty_prior_signal_mode=cfg.train.get("difficulty_prior_signal_mode", "rank_tanh"),
			...
			difficulty_stat_ema_beta=cfg.train.get("difficulty_stat_ema_beta", 0.99),
			...
			difficulty_signal_mode=cfg.train.get("difficulty_signal_mode", "rank_tanh"),
